  ...
  return <div className={styles.page}>
    ...
    <main className={styles.productMain}>
      ...
      <div className={styles.productSections}>
        ...
        <section><h2>Printing options</h2>{product.decoration_options.length ? <PrintingOptions methods={product.decoration_options} backend={backend} /> : <p>No customisation information available.</p>}</section>
